                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                ...
                                :dots="false" :nav="false"  :loop="true">
                                    <div class="pt" :class="thumbs[0] ==  gambar_default ? 'active' : ''"  @click="changImange(thumbs[0])">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImange(thumbs[1])" :class="thumbs[1] == gambar_default ? 'active' : ''">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details">
                                ...
                                <div class="quantity">
                                    <router-link to="/shop" class="primary-btn pd-cart">Add To Cart</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
